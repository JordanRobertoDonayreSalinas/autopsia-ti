            ...
            <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto custom-scroll">
                ...
                <div x-data="{ open: {{ request()->routeIs('usuario.reportes.*', 'usuario.auditoria.*') ? 'true' : 'false' }} }">
                    ...
                    <div x-show="open" x-transition:enter="transition ease-out duration-200"
                        ...
                        {{-- Consultorios (infraestructura y requerimientos) --}}
                        <a href="{{ route('usuario.reportes.consultorios') }}"
                            class="group relative flex items-center gap-3 px-4 py-2.5 rounded-lg transition-all {{ request()->routeIs('usuario.reportes.consultorios') ? 'bg-purple-600/10 text-purple-300' : 'text-slate-400 hover:text-white hover:bg-white/5' }}">
